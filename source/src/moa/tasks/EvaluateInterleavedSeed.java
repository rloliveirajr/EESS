 ...
 * This class implements a easy way in order to provide training seed to classifier.
 * 
 * @author Roberto L. de Oliveira Junior (robertolojr at dcc dot ufmg dot br)
 * @version $Revision: 1 $
 */
public class EvaluateInterleavedSeed extends MainTask {
    ...
    public ClassOption learnerOption = new ClassOption("learner", 'l',
            "Classifier to train.", Classifier.class, "rules.IncrementalLac");
    ...
    public ClassOption evaluatorOption = new ClassOption("evaluator", 'e',
            ...
            "BasicClassificationScoringEvaluator");
    ...
    public IntOption seedOption = new IntOption("trainingSeed",
            'g',
            "How many instances are used to be initial training set.",
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        //Creating training Seed 
        for(int i = 0; i < seedOption.getValue() && stream.hasMoreInstances(); i++){
